...
// Hàm định dạng ngày tháng (ví dụ: từ chuỗi ISO "2025-12-31T17:00:00.000Z" -> "31/12/2025")
  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.infoContainer}>
        ...
        {/* ========================================================= */}
        {/* ====== KHU VỰC HIỂN THỊ VOUCHER (ĐÃ THÊM VÀO) ====== */}
        {/* ========================================================= */}
        {hasDiscount && (
        ...
        <View style={styles.footerRow}>
          <View style={styles.priceSection}>
            ...
            {hasDiscount && (
              <Text style={styles.originalPrice}>{formatCurrency(originalItemPrice)}</Text>
            )}
          </View>
