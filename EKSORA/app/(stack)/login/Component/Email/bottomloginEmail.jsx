  ...
  return (
    <View style={styles.bottom}>
      ...
      <View style={styles.iconRow}>
        <TouchableOpacity
          style={[styles.iconButton, { backgroundColor: "#ea4335" }]} // Google
        ...
        <TouchableOpacity
          style={[styles.iconButton, { backgroundColor: "#4CAF50" }]} // Email
          onPress={() => router.push("/(stack)/login/loginPhone")}
        >
          <FontAwesome name="phone" size={24} color="white" />
        </TouchableOpacity>

        <TouchableOpacity
          style={[styles.iconButton, { backgroundColor: "#3b5998" }]} // Facebook
